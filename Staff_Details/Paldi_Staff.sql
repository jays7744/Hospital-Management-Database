...
CREATE TABLE Paldi_Staff(
    Department_ID INT FOREIGN KEY REFERENCES Paldi_Staff(Department_ID),
...
INSERT INTO Paldi_Staff (First_Name, Last_Name, Gender, Phone_Number, Department, Designation, Salary, Joining_Date, Address)
VALUES
